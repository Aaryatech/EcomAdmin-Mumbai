...
public class GetOrderDetailDisplay {
	...
	List<GetOrderTrailDisplay> trailList;
	...
	public List<GetOrderTrailDisplay> getTrailList() {
		return trailList;
	}

	public void setTrailList(List<GetOrderTrailDisplay> trailList) {
	...
	public String toString() {
		return "GetOrderDetailDisplay [orderDetailId=" + orderDetailId + ", orderId=" + orderId + ", itemId=" + itemId
				...
				+ itemName + ", catId=" + catId + ", itemPic=" + itemPic + ", catName=" + catName + ", itemUom="
