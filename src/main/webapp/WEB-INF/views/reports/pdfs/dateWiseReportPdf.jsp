...
<title>Date Wise Bill Report</title>
<style type="text/css">
@media print {
	.no-break {
...
<body>
					<div class="no-break">
						...
						<div
						 ...
						 <div
							...
							<h4
								style="color: #000; font-size: 16px; text-align: center; margin: 0px;">Date Wise Bill Report</h4>
				...
				style="border-top: 1px solid #313131;" class="table datatable-header-basic">
					...
					<c:forEach items="${dateBillRep}" var="order" varStatus="count">
							<tr>
								<td width="5%">${srno}</td>
								<td width="10%" style="text-align: center;">${order.billDate}</td>
