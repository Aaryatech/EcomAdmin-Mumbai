...
<body class="sidebar-xs">
			...
			<div class="content">
				...
				<div class="card">
					...
					<div
						...
						<%-- <c:if test="${addAccess==0}"> --%>
							<span class="font-size-sm text-uppercase font-weight-semibold"><a
								class="card-title"
								href="${pageContext.request.contextPath}/configHomePageProduct"
								style="color: white;"><i class="icon-add-to-list ml-2"
									style="font-size: 23px;"></i>&nbsp;&nbsp;&nbsp;&nbsp;Configure Home 
									Page Product</a></span>
						<%-- </c:if> --%>
					</div>
					...
					<table class="table datatable-header-basic">
						...
						<tbody>
							<c:forEach items="${homePageList}" var="list" varStatus="count">
								<tr>
									<td>${count.index+1}</td>
									<td>${list.exVar2}</td>
									...
									<td class="text-center"><%-- <c:if test="${editAccess==0}"> --%>
											<div class="list-icons">
												<a
													href="${pageContext.request.contextPath}/editHomePagePrdctConfig?homePageStatusId=${list.exVar1}"
	...
	<script type="text/javascript">
							...
							bootbox
									.confirm({
										...
										callback : function(result) {
											if (result) {
												location.href = "${pageContext.request.contextPath}/deleteHomePagePrdctConfig?homePageStatusId="
														+ uuid;
		...
		function genPdf() {
			window
					.open("${pageContext.request.contextPath}/pdfReport?url=pdf/printHmPgConfigPdf");
		}
	</script>
</body>
</html>