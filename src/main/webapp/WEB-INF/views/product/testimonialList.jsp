...
<c:url value="/getHmPgTesmnlPrint" var="getHmPgTesmnlPrint"></c:url>
					...
					<div
						...
						<c:if test="${addAccess==0}">
							<span class="font-size-sm text-uppercase font-weight-semibold"><a
								class="card-title"
								href="${pageContext.request.contextPath}/newTestimonial"
								style="color: white;"><i class="icon-add-to-list ml-2"
									style="font-size: 23px;"></i>&nbsp;&nbsp;&nbsp;&nbsp;Add Home Page Testimonial</a></span>
						</c:if>
					</div>
								...
								<tr>
									...
									<td class="text-center"><c:if test="${editAccess==0}">
											<div class="list-icons">
												<a
													href="${pageContext.request.contextPath}/editTestimonial?testimonialId=${list.exVar1}"
							...
							bootbox
									.confirm({
										...
										callback : function(result) {
											if (result) {
												location.href = "${pageContext.request.contextPath}/deleteTestimonial?testimonialId="
														+ uuid;
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header bg-primary">
								<h6 class="modal-title">Home Page Testimonial List</h6>
									...
									if(data!=null){
										...
										if(val==1){
											...
											if($("#chkPdf").is(":checked")){
											 ...
											 window.open('${pageContext.request.contextPath}/pdfReport?url=pdf/getHmPgTesmnlListPdf/'+compId+"/"+elemntIds.join()+'/'+showHead);
											 $('#selAllChk').prop('checked', false);
										}
									}
								});
