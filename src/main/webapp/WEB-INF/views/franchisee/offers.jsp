	...
	var modalTemplate = '<div class="modal-dialog modal-lg" role="document">\n'
		...
		$('.file-input-ajax1')
				...
				.fileinput(
						{
							browseLabel : 'Browse',
							uploadUrl : "http://198.12.156.31:8080/ecomAdmin/ajaxImageUploadOffer/"+offerId, // server upload action
 							uploadAsync : false,
							maxFileCount : 100,
							initialPreview : [],
			...
			$.getJSON('${getItemListForOfferDetail}',
					...
					function(data) {
						...
						$.each(data.catList,function(key, category) {
									...
									tr.append($('<td  style="padding: 7px; line-height:0; color:#fff; border-top:0px; font-weight:700;" colspan=2></td>').html(category.catName));
