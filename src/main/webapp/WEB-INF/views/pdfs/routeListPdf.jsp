...
<body>
					<div class="no-break">
						...
						<div
							...
							<h4
								style="color: #000; font-size: 16px; text-align: center; margin: 0px;">Route List Pdf</h4>							
								<%-- <p
		...
		<table align="center" border="1" cellpadding="0" cellspacing="0"
			...
			<c:forEach items="${routeListPrint}" var="route" varStatus="count">
				<tr>
					<c:forEach items="${routeIds}" var="routeIds">
					<c:if test="${routeIds==1}">
						<td>${count.index+1}</td>
					...
					<c:if test="${routeIds==2}">
						<td width="20%;">${route.routeName}</td>
					</c:if>
