...
<body>
					<div class="no-break">
						...
						<div
							...
							<h4
								style="color: #000; font-size: 16px; text-align: center; margin: 0px;">Category List Pdf</h4>							
								<%-- <p
		...
		<table align="center" border="1" cellpadding="0" cellspacing="0"
			...
			<c:forEach items="${homePageList}" var="homePageList" varStatus="count">
				<tr>
					<td>${count.index+1}</td>
					<td>${homePageList.exVar2}</td>
					<td>${homePageList.isActive==1 ? 'Active' : 'In-Active'}</td>
				</tr>
			</c:forEach>
		</table>
	</div>
