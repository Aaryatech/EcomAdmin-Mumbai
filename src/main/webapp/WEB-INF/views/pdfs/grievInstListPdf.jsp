...
<title>Grievance Type Instruction List</title>
<style type="text/css">
@media print {
	.no-break {
...
<body>
					<div class="no-break">
						...
						<div
							...
							<h4
								style="color: #000; font-size: 16px; text-align: center; margin: 0px; margin-bottom: 5px;">Grievance Type Instruction List</h4>							
								<%-- <p
