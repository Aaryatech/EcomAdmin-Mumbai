...
<title>Related Product Configuration</title>
<style type="text/css">
@media print {
	.no-break {
...
<body>
					<div class="no-break">
						...
						<div
							...
							<h4
								style="color: #000; font-size: 16px; text-align: center; margin: 0px;">Related Product Configuration</h4>							
								<%-- <p
		...
		<table align="center" border="1" cellpadding="0" cellspacing="0"
			...
			<c:forEach items="${relProList}" var="relProList" varStatus="count">
				<tr>
					<td>${count.index+1}</td>
					<td>${relProList.primaryItem}</td>
					<td>${relProList.prodList}</td>
				</tr>
			</c:forEach>
		</table>
	</div>
