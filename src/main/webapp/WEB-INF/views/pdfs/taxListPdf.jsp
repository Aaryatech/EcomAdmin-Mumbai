...
<body>
					<div class="no-break">
						...
						<div
							...
							<h4
								style="color: #000; font-size: 16px; text-align: center; margin: 0px;">Tax List Pdf</h4>							
								<%-- <p
		...
		<table align="center" border="1" cellpadding="0" cellspacing="0"
			...
			<tr>
				<c:forEach items="${taxIds}" var="taxIds" varStatus="count">
			...
			<c:forEach items="${taxList}" var="taxList" varStatus="count">
				<tr>
					<c:forEach items="${taxIds}" var="taxIds">
