...
<title>Route Delivery List</title>
<style type="text/css">
@media print {
	.no-break {
...
<body>
					<div class="no-break">
						...
						<div
							...
							<h4
								style="color: #000; font-size: 16px; text-align: center; margin: 0px;">Route Delivery List</h4>							
								<%-- <p
		...
		<table align="center" border="1" cellpadding="0" cellspacing="0"
			...
			<c:forEach items="${routeDelList}" var="routeDelList" varStatus="count">
				<tr>
					<td>${count.index+1}</td>
					<td>${routeDelList.deliveryName}</td>
					<td>${routeDelList.timeSlots}</td>
					<td>${routeDelList.sortNo}</td>
				</tr>
			</c:forEach>
		</table>
	</div>
