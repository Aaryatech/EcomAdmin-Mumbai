...
<body>
					<div class="no-break">
						...
						<div
							...
							<h4
								style="color: #000; font-size: 16px; text-align: center; margin: 0px;">Language List Pdf</h4>							
								<%-- <p
		...
		<table align="center" border="1" cellpadding="0" cellspacing="0"
			...
			<c:forEach items="${langPrintList}" var="langList" varStatus="count">
				<tr>
					<td>${count.index+1}</td>
					<td>${langList.langCode}</td>
					<td>${langList.langName}</td>								
					<td>${langList.isActive==1 ? 'Active' : 'In-Active'}</td>	
				</tr>
			</c:forEach>
		</table>
	</div>
