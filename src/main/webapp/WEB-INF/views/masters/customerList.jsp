							...
							<c:forEach items="${custList}" var="custList" varStatus="count">
								<tr>
									...
									<td class="text-center"><c:if test="${editAccess==0}">
										...
										<div class="list-icons">
												<a
													href="${pageContext.request.contextPath}/showCustomerAddDet?custId=${custList.exVar1}"
												...
												<div class="list-icons">
												<a
													href="${pageContext.request.contextPath}/showAddCustomerAddDet?custId=${custList.exVar1}"
