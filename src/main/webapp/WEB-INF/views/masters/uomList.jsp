				...
				<div class="card">
					...
					<div
						...
						<span
							...
							style="color: white;"><i
								class="icon-add-to-list ml-2" style="font-size: 23px;"></i>&nbsp;&nbsp;&nbsp;&nbsp;Add UOM</a></span>
					</div>
						...
						<tbody>
							<c:forEach items="${uomList}" var="uomList" varStatus="count">
								 <tr>
									...
									<td>${uomList.isActive==0 ? 'Active' : 'In-Active'}</td>									
									<td style="display: none;"></td>
									<td style="display: none;"></td>							
									<td class="text-center">
										<div class="list-icons">
											<a href="${pageContext.request.contextPath}/editUom?uomId=${uomList.exVar1}"
										...
										<a href="javascript:void(0)"
													...
													data-uuid="${uomList.exVar1}" data-popup="tooltip"
