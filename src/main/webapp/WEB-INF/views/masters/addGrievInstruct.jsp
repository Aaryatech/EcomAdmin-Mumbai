...
<body class="sidebar-xs">
	<c:url value="/getGrievanceCaptionInfo" var="getGrievanceCaptionInfo"></c:url>
	<!-- Main navbar -->
									...
									<div class="form-group row">
										...
										<div class="col-lg-10">
											<textarea class="form-control maxlength-badge-position"
												...
												maxlength="200" onchange="trim(this)">${griev.description}</textarea>
										</div>
									</div>
												...
												<c:when test="${griev.grevTypeId>0}">
													...
													<div class="form-check form-check-inline">
														<label class="form-check-label"> <input
															...
															${griev.isActive==0 ? 'checked' : ''}> In-Active
														</label>
													</div>
												</c:when>
												<c:otherwise>
												...
												<c:when test="${griev.grevTypeId>0}">
													<div class="form-check form-check-inline">
														<label class="form-check-label"> <input
															...
															${griev.allowToCopy==1 ? 'checked' : ''}> Yes
														</label>
													</div>
													...
													<div class="form-check form-check-inline">
														<label class="form-check-label "> <input
															...
															${griev.allowToCopy==0 ? 'checked' : ''}> No
														</label>
													</div>
												</c:when>
												<c:otherwise>
	...
	<script type="text/javascript">
		...
		$("#griev_cap").change(function() { // 1st
			...
			var grievId = $("#griev_id").val();
			//alert(code)

			$.getJSON('${getGrievanceCaptionInfo}', {
				caption : caption,
				grievId : grievId,
				ajax : 'true',
			}, function(data) {
