...
<body class="sidebar-xs">
	...
	<c:url value="/getOrderDashDetailByBillId"
		var="getOrderDashDetailByBillId" />
		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card signle_row" style="padding: 15px 0px 10px 15px;">
					<form action="${pageContext.request.contextPath}/getDashCountData"
						...
						<div class="row">
								...
								<div class="radio_row_l">
									...
									<div class="form-check form-check-inline">
										<label class="form-check-label"> <input type="radio"
											class="form-check-input" name="calRadio" id="dayRadio"
											checked="checked" value="1" onclick="showDiv(1)"
											${radVal==1 ? 'checked' : ''}> Day
										</label>
									</div>
									<div class="form-check form-check-inline">
										<label class="form-check-label"> <input type="radio"
											class="form-check-input" name="calRadio" id="weekRadio"
											value="2" onclick="showDiv(2)" ${radVal==2 ? 'checked' : ''}>
											Week
										</label>
									</div>
									<div class="form-check form-check-inline">
										<label class="form-check-label"> <input type="radio"
											class="form-check-input" name="calRadio" id="monthRadio"
											value="3" onclick="showDiv(3)" ${radVal==3 ? 'checked' : ''}>
											Month
										</label>
									</div>
									<div class="form-check form-check-inline">
										<label class="form-check-label"> <input type="radio"
											class="form-check-input" name="calRadio" id="custRadio"
											value="4" onclick="showDiv(4)" ${radVal==4 ? 'checked' : ''}>
											Customize
										</label>
									</div>
								</div>
							...
							<div class="col-lg-2">
								<button type="submit" class="btn bg-teal legitRipple">Search</button>
							</div>
					...
					<c:forEach items="${statusCnt}" var="statusCnt" varStatus="count">
						<c:if test="${!empty statusCnt.statusName}">
							<div class="col-sm-6 col-xl-3"
								onclick="getOrderDetailData(${statusCnt.orderStatus})">
